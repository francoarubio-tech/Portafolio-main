...
function handleSubmit(event) {
    ...
    $buttonMailto.setAttribute('href', `mailto:francoarubio@gmail.com?subjet= nombre ${form.get('name')} asunto ${form.get('affair')} correo ${form.get('email')}&body=${form.get('message')}`)
    $buttonMailto.click()
}
